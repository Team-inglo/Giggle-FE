...
const ProgressPage = () => {
  ...
  const access_token =
    "eyJKV1QiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJ1dWlkIjoxLCJyb2xlIjoiQVBQTElDQU5UIiwiaWF0IjoxNzI0ODIyNDcyLCJleHAiOjE3MjU0MjcyNzJ9.yirYU820QAraRvwr3aJjtGYqZrCvQfoqjgEsGcyjyORbmrdqhy2FZiS1nU0S3BIJRtexHzEh7XZ0e2JoOffp2A"; // 실제 액세스 토큰으로 대체
  ...
  useEffect(() => {
    const fetchLogs = async () => {
      try {
        const data = await requestSignatureGet({
          access_token,
          userId,
          status,
        });
